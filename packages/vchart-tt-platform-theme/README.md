...
The extension [Semi Design](https://github.com/DouyinFE/semi-design) themes for [VChart](https://github.com/VisActor/VChart).
...
![img](https://lf9-static.semi.design/obj/semi-tos/images/introduction-showcase.gif)
